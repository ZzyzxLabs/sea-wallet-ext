...
// Helper to merge default and custom className
...
export const LoadingSpinnerIcon: React.FC<IconProps> = ({ className }) => (
  <svg
    width="16" height="16"
    className={mergeClassName('h-4 w-4 animate-spin text-yellow-500', className)}
...
export const CheckCircleIcon: React.FC<IconProps> = ({ className }) => (
  <svg 
    width="16" height="16"
    className={mergeClassName('h-4 w-4 text-green-500', className)}
    xmlns="http://www.w3.org/2000/svg" 
    fill="none" 
    viewBox="0 0 24 24" 
    stroke="currentColor"
...
export const ExclamationTriangleIcon: React.FC<IconProps> = ({ className }) => (
  <svg 
    width="16" height="16"
    className={mergeClassName('h-4 w-4 text-red-500', className)}
    xmlns="http://www.w3.org/2000/svg" 
    fill="none" 
    viewBox="0 0 24 24" 
    stroke="currentColor"
...
export const InformationCircleIcon: React.FC<IconProps> = ({ className }) => (
  <svg 
    width="16" height="16"
    className={mergeClassName('h-4 w-4 text-gray-400', className)}
    xmlns="http://www.w3.org/2000/svg" 
    fill="none" 
    viewBox="0 0 24 24" 
    stroke="currentColor"
